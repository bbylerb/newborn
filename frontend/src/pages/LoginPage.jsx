    ...
    <div className="full-page">
      <div style={{ background: 'linear-gradient(160deg,#C8102E 0%,#9B0C23 48%,#0f172a 100%)', flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ padding: '48px 32px 24px', textAlign: 'center' }}>
          <div style={{ width: 68, height: 68, background: 'rgba(255,255,255,.15)', borderRadius: 22, margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,.25)' }}>
        ...
        <div style={{ background: 'var(--card)', borderRadius: '28px 28px 0 0', padding: '28px 24px 40px', flex: 1, overflowY: 'auto' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 24 }}>
            <div className="lang-toggle">
              <button type="button" className={`lang-btn${i18n.language === 'en' ? ' active' : ''}`} onClick={() => switchLang('en')}>
                <Globe size={12} style={{ display: 'inline', marginRight: 4 }} />EN
              </button>
              <button type="button" className={`lang-btn${i18n.language === 'th' ? ' active' : ''}`} onClick={() => switchLang('th')}>
                <Globe size={12} style={{ display: 'inline', marginRight: 4 }} />TH
              </button>
            </div>
          </div>
